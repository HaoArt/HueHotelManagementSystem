  ...
  return (
    <Card
      ...
      sx={{
        ...
        position: "relative",
        height: "100%", // Ép thẻ giãn đều 100% chiều cao của lưới
    ...
    >
      ...
      <CardContent
        sx={{
          ...
          display: "flex",
          flexDirection: "column",
          p: { xs: 2.5, md: 3 }, // Giảm padding để có thêm không gian ngang
        }}
      >
        <Typography
          variant="h5"
        ...
        {/* VÁ LỖI VỠ DÒNG ICONS Ở ĐÂY */}
        <Box
          sx={{
            display: "flex",
            justifyContent: "space-between", // Tự dãn đều sang 2 bên
            alignItems: "center",
            mb: 2.5,
            color: LUXURY.charcoal,
          }}
        ...
        <Typography
          ...
          sx={{
            mb: 3,
            flexGrow: 1, // Tự động đẩy phần giá tiền & nút bấm xuống đáy
            lineHeight: 1.7,
            display: "-webkit-box",
            WebkitLineClamp: 2,
